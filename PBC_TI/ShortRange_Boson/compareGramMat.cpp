...
int main(int argc, char* argv[]) {
	...
	ManyBodyBosonSpace                       locSpace(Lloc, Nloc);
	mBodyOpSpace<ManyBodyBosonSpace, Scalar> locOpSpace(m, locSpace);
...
#pragma omp parallel for
	...
	ManyBodyBosonSpace                       globSpace(Lglob, Nglob);
	mBodyOpSpace<ManyBodyBosonSpace, Scalar> globOpSpace(m, globSpace);
